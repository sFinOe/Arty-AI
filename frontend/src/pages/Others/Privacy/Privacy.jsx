    ...
    <Grid>
      <Container size="xl">
        ...
        <Grid className={Styles.Card_layout}>
          <Grid>
            <h1>Privacy Policy for {Appconfig.app_name}</h1>

            <p>
              At {Appconfig.app_name}, accessible from {Appconfig.app_name}.com, one of our main priorities is the privacy of our visitors. This
              Privacy Policy document contains types of information that is collected and recorded by {Appconfig.app_name} and how we use it.
            </p>
            ...
            <p>
              ...
              they shared and/or collect in {Appconfig.app_name}. This policy is not applicable to any information collected offline or via channels
            ...
            <p>
              {Appconfig.app_name} follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting
              ...
              addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks.
            ...
            <p>
              Like any other website, {Appconfig.app_name} uses "cookies". These cookies are used to store information including visitors'
            ...
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of {Appconfig.app_name}.</p>
            ...
            <p>
              ...
              advertisements and links that appear on {Appconfig.app_name}, which are sent directly to users' browser. They automatically receive your
            ...
            <p>Note that {Appconfig.app_name} has no access to or control over these cookies that are used by third-party advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>
              {Appconfig.app_name}'s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
            ...
            <p>
              {Appconfig.app_name} does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think
              that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our
